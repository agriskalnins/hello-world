...
function SvetkuDienas ($sv_diena, $sv_menesis)
    {
        ...
        //mysql_query("SET NAMES 'cp1257'") or die ("Neizdevās iestatīt valodu!");
        mysql_query('SET NAMES UTF8') or die (mysql_error($connection));
        if (!$connection)
        {
        ...
        $result = mysql_query("SELECT * FROM web_svetku_dienas");
