		...
		while($row2 = mysql_fetch_array($result2))
	   	{
			...
			{
				echo "<div id='fragment-$b' class='ui-tabs-panel ui-tabs-hide' style=''>";
			}
				echo "<div class='main_act'>
					 <div class='info' >
					 	<div align='left' style='border: solid 0px #CCC; border-left:solid 6px #c60202; padding-left:7px;'>
...
//---------------------------------------------------------Aktualitates titulbilde---------------------------------------------------------------------
				...
				{
					echo "<img src=". $Notikuma_titulbilde . $row2['not_titulbilde'] . " width=259px style='border: solid 2px #13529d;margin-top:4px;'>";
				}
...
andrew2: 	echo "<div class='crumbi' width=100% align=right>";
			echo "<a href=";if(isset($ser)){echo $ser;}echo "index.php?view=archive>Notikumu arhīvs &rsaquo;</a> ";
			echo "</div>";
}
