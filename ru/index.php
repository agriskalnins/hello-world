<?php
	...
	include '../conf.php';
 	$ser1 = 'http://' . ServerNos() . '/';
 	$ser2 = 'http://' . ServerNos() . '/en/';
	$ser = 'http://' . ServerNos() . '/ru/';
	include 'var.php';
...
echo "
    <div id='header'>
    	<div class='top_schortcut'>
			...
			<a href=";if(isset($ser2)){echo $ser2;} echo"><img src=".$cel_img3."en.png width=22px style='margin-left:3px;'></a>
    		<a href=";if(isset($ser)){echo $ser;} echo"><img src=".$cel_img3."ru.png width=22px style='margin-left:3px;'></a>";
...
echo "		<a href=\"JavaScript:newPopup('http://www.zrkac.lv/RMums.php');\"><span style='display: inline-block;vertical-align: middle;line-height: normal;margin-bottom:15px;'>Написать нам</span></a>";
...
echo "		<a href=\"JavaScript:newPopup('http://www.zrkac.lv/MA.php');\"><img src=".$cel_img3."map.png width=20px style='margin-bottom:2px;margin-left:8px;'></a>
			<a href=\"JavaScript:newPopup('http://www.zrkac.lv/MA.php');\"><span style='display: inline-block;vertical-align: middle;line-height: normal;margin-bottom:15px;'>Мы находимся</span></a>";
...
echo "		<span style='display: inline-block;vertical-align: middle;line-height: normal;margin-bottom:15px;'><a href=\"JavaScript:newPopup('http://www.zrkac.lv/piet.php');\">Записаться</a></span>";
...
echo "
        ...
        <a href=";if(isset($ser)){echo $ser;} echo "><div class='Logo_div'>
             <img src=".$cel_img2."ZRKAC_RUS.png>
        </div></a>
...
echo "  <a href=\"JavaScript:newPopup('http://www.zrkac.lv/RMums.php');\"><img  style='border:0px; vertical-align: middle; margin-left:25px; margin-right:5px;' alt='Contact us' src=".$cel_img."mail2.png height=20px></a><span style=' margin-top:0px;border: solid 0px #636363; color:#FFF;'><a href=\"JavaScript:newPopup('http://www.zrkac.lv/RMums.php');\">Oбщайтесь</a></span>
        <a href=\"JavaScript:newPopup('http://www.zrkac.lv/MA.php');\"><img style='border:0px; vertical-align: middle; margin-left:25px; margin-right:5px;' alt='Map' src=".$cel_img."map.png height=17px><span style='margin-top:0px; margin-bottom:5px; border: solid 0px #636363; color:#FFF;'></a><a href=\"JavaScript:newPopup('http://www.zrkac.lv/MA.php');\">Как нас найти</a></span>
    </div>";
...
echo "
        <div id='footer-left-sidebar'>
            ...
            <img style='border: solid 0px #636363;' alt='' src='".$cel_img2."ZRKAC_RUS_small.png' width='260px' ></a>
            <p align=left style='margin-top: 3px; margin-bottom: 20px' class=graytext>Светес 33, Елгава, LV-3001<br>
            Tелефон: 63082101; <br>Факс: 63007033<br>
            Э-почта: birojs@zrkac.jelgava.lv<br>
            www.zrkac.lv</p>
        </div>";
/*------------------------------------- vidus  footerā ----------------------------*/
echo "
...
echo "    <!--<a href=#></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"JavaScript:newPopup('http://www.zrkac.lv/RMums.php');\">Оставьте сообщение</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"JavaScript:newPopup('http://www.zrkac.lv/MA.php');\">Как нас найти</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=".$ser. "index.php?view=en&id=20>Kонтакт</a><br />";
echo "Дизайн: ZRKAC &#169; 2013<br>";
