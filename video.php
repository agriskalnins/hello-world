...
$_REQUEST = array_map('stripslashes_deep', $_REQUEST);
	...
	$lapas_nosaukums1 = 'Video galerija';
...
echo "
	...
	if ($gal_id == null)
	{
		...
		echo "<a href=".$ser."index.php>Sākums</a> &rsaquo; <a href=";if(isset($ser)){echo $ser;} echo "video.php>Video galerija</a>";
		echo "
			</div>";
		/*Eventa nosaukums*/
		echo "
...
echo "
		<div width=100% style='margin-top:45px;margin-left:17px;margin-bottom:10px;'>
			<a href='#' onclick='history.go(-1);return false;'><b>&#139;</b> Atgriezties</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href=";if(isset($ser)){echo $ser;} echo "video.php> Uz video galeriju</a>
		</div>";
